...
SERVICES_DATABASE = ''
SERVICES_DATABASE_SERVER_PORT = None
SERVICES_DATABASE_SERVER_URL = ''
...
SECRET_KEY = 'jm3-0v8&amp;^jdzj!xe9qao*vrbagzpr2lhi0l_^#p%%6kt$(=qov'
...
WSGI_APPLICATION = 'renki.wsgi.application'
...
assert SERVICES_DATABASE, 'SERVICES_DATABASE must be set'
assert SERVICES_DATABASE_SERVER, 'SERVICES_DATABASE_SERVER must be set'
